  ...
  const renderChat = () => {
      ...
      <div className="notification-event">
        <span className="chat-message-item">
		 <div >
  <div className="chat-thumb"><img src="images/resources/ahmed.gif" alt /></div>
  <div className="notification-event">
    <span className="chat-message-item">
    {post}
...
<div className="theme-layout">
          ...
          <div className="col-lg-12">
            <div className="top-banner">
              ...
              <nav className="breadcrumb">
                ...
                <span className="breadcrumb-item active">Donation Detail</span>
              </nav>
            </div>
          </div>
        </div>
  ...
  <div className="chat-head">
    ...
    <div className="more">
      ...
      <span className="close-mesage" ><i className="ti-close" onClick={close} /></span>
    </div>
  </div>
  <div className="chat-list">
    ...
    <form className="text-box" onSubmit={handleSubmit(onSubmit)}>
      <textarea name= "post" id="textarea" defaultValue={""}  {...register('post')} placeholder="Post enter to post..." />
                  ...
                  <div className="full-postmeta">
                    ...
                    <div className="prod categories">
                      <span className="cat-heading">Categories:
                        <a href="#" title>{state.category}</a>
                      </span>
                    </div>
                    <div className="prod tags">
                      <span className="cat-heading">Location:
                        <a href="#" title>{state.location}</a>
                      </span>
                    </div>
                    <div className="prod tags">
                      <span className="cat-heading">State:
                      <i className="colorstate"> {state.state}</i>
                      </span>
                    </div>
                    <div>
           <Avatar onClick={change} alt="Remy Sharp" src="images/resources/ahmed.gif" />
              ...
              <div className="gap no-bottom">
                <div className="tab-section">
                  <ul className="nav nav-tabs single-btn">
                    <li className="nav-item"><a className="active" href="#desc" data-toggle="tab">Description</a></li>
                    <li className="nav-item"><a className href="#additional" data-toggle="tab">Additional Information</a></li>
                    <li className="nav-item"><a className href="#review" data-toggle="tab">Reviews (2)</a></li>
                  </ul>
                  {/* Tab panes */}
                  <div className="tab-content">
                    <div className="tab-pane active fade show " id="desc">
                      <div className="more-pix">
                        <h2 className="main-title text-center">Shoes for Men Black</h2>
                        <div className="row">
                    ...
                    <div className="tab-pane fade" id="additional">
                      <div className="aditional-inf">
                        <h2 className="main-title">Shoes for Men Black</h2>
                    ...
                    <div className="tab-pane fade" id="review">
                      <div className="woocommerce-Reviews">
                          ...
                          <ol className="commentlist">
                            <li>
                              <div className="comment_container">
                                <img src="images/resources/single-comment1.jpg" alt className="avatar" />
                                <div className="comment-text">
                                  <span className="user-name">Jason Bourne</span>
                            ...
                            <li>
                              <div className="comment_container">
                                <img src="images/resources/single-comment1.jpg" alt className="avatar" />
                                <div className="comment-text">
                                  <span className="user-name">Jhon Cena</span>
                        ...
                        <div id="respond" className="comment-respond">
                          <h3 className="reply-title">Post Your Review:</h3>
                          <div className="star-rating">
                            <label>Rating:</label>
                            <span><i className="fa fa-star" /></span>
                            <span><i className="fa fa-star" /></span>
                          ...
                          <form method="post">
                            ...
                            <p className="comment-notes">
                              <textarea placeholder="Enter your review*" defaultValue={""} />
                            </p>
                          </form>

...
import { DataManager, UrlAdaptor  ,ODataV4Adaptor,WebApiAdaptor } from '@syncfusion/ej2-data';
...
useEffect(() => {
  ///fetchdata();
 // const e =[]
 //axios.post("http://localhost:2600/compaign/GetData").then((res) => {
                ...
                <div className="container-fluid">
                  <div className="row" id="page-contents">
                    <div className="col-lg-9">
                      <div className="blog-sec left-pading">
                      <div>
                <div className="control-section">
        <div className="schedule-control"></div>
   <ScheduleComponent id="schedule" height='550px' width='950px'  currentView="Month" eventSettings={{ dataSource:dataManager}}>
      <ViewsDirective>

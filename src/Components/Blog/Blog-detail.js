...
const BlogDetail = () => {
  ...
  async function fetchdata() {
    const id = state._id;
    await axios
      .get("http://localhost:2600/comment/getcomment/" + `${id}`)
      .then((result) => {
        setcomments(result.data);
      });
    await axios
      .get("http://localhost:2600/comment/getcommentcount/" + `${id}`)
      .then((result) => {
        setsnbrcomments(result.data.nbrcomment);
      });
    await axios
      .get("http://localhost:2600/reply/getreply/" + `${id}`)
      .then((result) => {
  ...
  const fetchcomments = async () => {
    await axios
      .get("http://localhost:2600/comment/getcomment/" + `${state._id}`)
      .then((result) => {
        ...
        <div className="theme-layout">
                  ...
                  <div className="offset-lg-1 col-lg-10">
                    <div className="detail-page">
                      ...
                      <div className="detail-meta">
                        <h2>
                          The Nike Air Zoom Pegasus 33 Print Big Kids' Running
                          Shoe
                        </h2>
                        ...
                        <p>
                          ...
                          Wick is forced back associate plotting. Lorem ipsum
                        ...
                        <blockquote>
                          <p>
                            ...
                            elit, sed do eiusmod tempor dolore magna aliqua. ”
                          </p>
                        </blockquote>
                        <p>
                          Lorem ipsum dolor sit amet, consectetur adipiscing
                        ...
                        <p>
                          Lorem ipsum dolor sit amet, consectetur adipi slabore
                          et dolore magna aliqua. Ut enim ad minim irure dolor
                          in reprehenderit.
                        </p>
                        <ul>
                          <li>
                          ...
                          <li>
                            Mauris laoreet, nisl id faucibus pellentesque, mi mi
                          </li>
                          <li>
                            Vivamus accumsan nisl id massa finibus aliquet
                          </li>
                        ...
                        <div className="tag-n-cat">
                          <div className="tags">
                            <span>
                              <i className="fa fa-tags" /> Post Tags:
                            </span>
                            <a href="#" title>
                              News
                            </a>
                          ...
                          <div className="tags">
                            <span>
                              <i className="fa fa-filter" /> Post Categories:
                            </span>
                            <a href="#" title>
                              News
                            </a>
          ...
          <section>
            <div className="gap no-gap bluesh high-opacity btm-mockup">
              <div
                className="content-bg-wrap"
                style={{ background: "url(images/resources/btm-banner.png)" }}
              />
              <div className="container">
                <div className="row">
                  <div className="col-lg-12">

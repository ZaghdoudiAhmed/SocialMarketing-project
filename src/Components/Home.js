...
import Donationbystate from './Donation/Donationbystate';
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="top-banner">
                <h1>Liste des dons à {state[0].location} </h1>
        ...
        <div className="container-fluid">
          <div className="row" id="page-contents">
            <div className="col-lg-9">
             ...
             { state.map((donationbystate)=>{

                 return (<Donationbystate name={donationbystate}></Donationbystate>)
             })}

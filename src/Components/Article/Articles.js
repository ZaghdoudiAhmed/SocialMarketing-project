...
function Articles(props) {
 ...
 //axios.get("https://newsapi.org/v2/everything?apiKey=1d7f906227b14d20a952ea12ea4fced6&q=Product").then(responsive=>{
  //setnewArticle(responsive.data.articles);
 // const number="five";
 // const parsedNumber = number.length > 2 ? wordsToNumbers((number), { fuzzy: true }) : number;
 //  console.log(responsive.data.articles[parsedNumber-1]);
 // });
 },[])
  return (
    <div>
...
<main>
  ...
  <section className="container">
    <div className="site-content">
      <div className="posts">
      {newArticles.length>0?(newArticles.map((article,index) => {return(<Article key={index} newarticle={article}>  <hr /></Article>)}))
      
      :(<div>Speak with alan to get the latest articles around the world</div>)}
        ...
        <div className="popular-post">
          ...
          <div className="post-content" data-aos="flip-up" data-aos-delay={200}>
            <div className="post-image">
              <div>
                <img src="assets/popular-post/m-blog-1.jpg" className="img2" alt="blog1" />
              </div>
          ...
          <div className="post-content" data-aos="flip-up" data-aos-delay={300}>
            <div className="post-image">
              <div>
                <img src="assets/popular-post/m-blog-2.jpg" className="img2" alt="blog1" />
              </div>
              <div className="post-info flex-row">
                <span><i className="fas fa-calendar-alt text-gray" />&nbsp;&nbsp;January 14,
                  2019</span>
          ...
          <div className="post-content" data-aos="flip-up" data-aos-delay={400}>
            <div className="post-image">
              <div>
                <img src="assets/popular-post/m-blog-3.jpg" className="img2" alt="blog1" />
              </div>
              <div className="post-info flex-row">
                <span><i className="fas fa-calendar-alt text-gray" />&nbsp;&nbsp;January 14,
                  2019</span>
          ...
          <div className="post-content" data-aos="flip-up" data-aos-delay={500}>
            <div className="post-image">
              <div>
                <img src="assets/popular-post/m-blog-4.jpg" className="img2" alt="blog1" />
              </div>
              <div className="post-info flex-row">
                <span><i className="fas fa-calendar-alt text-gray" />&nbsp;&nbsp;January 14,
                  2019</span>
          ...
          <div className="post-content" data-aos="flip-up" data-aos-delay={600}>
            <div className="post-image">
              <div>
                <img src="assets/popular-post/m-blog-5.jpg" className="img2" alt="blog1" />
              </div>
              <div className="post-info flex-row">
                <span><i className="fas fa-calendar-alt text-gray" />&nbsp;&nbsp;January 14,
                  2019</span>
  ...
  {/* -----------x---------- Site Content -------------x----------*/}
          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="our-teambox">
                <figure><img src="images/resources/team1.jpg" alt="true" /></figure>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="our-teambox">
                <figure><img src="images/resources/team2.jpg" alt="true" /></figure>
                <div className="team-info">
                  <h4>Peeter Paker</h4>
                  <span>Developer</span>
                </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="our-teambox">
                <figure><img src="images/resources/team3.jpg" alt="true" /></figure>
                <div className="team-info">
                  <h4>Amy watson</h4>
                  <span>Support</span>
                </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="our-teambox">
                <figure><img src="images/resources/team4.jpg" alt="true" /></figure>
                <div className="team-info">
                  <h4>jaison born</h4>
    ...
    <section>
      <div className="getquot-baner">
        ...
        <a title="true"href="#">Get a Quote</a>
      </div>
    </section>{/* get a quote */}
    <footer>
      <div className="container">
          ...
          <div className="col-lg-4 col-md-4">
            <div className="widget">
              <div className="foot-logo">
                <div className="logo">
                  <a href="index-2.html" title="true"><img src="images/logo.png" alt="true" /></a>
                </div>	
                <p>
          ...
          <div className="col-lg-2 col-md-4">
            <div className="widget">
              ...
              <ul className="list-style">
                <li><i className="fa fa-facebook-square" /> <a href="https://web.facebook.com/shopcircut/" title="true">facebook</a></li>
                <li><i className="fa fa-twitter-square" /><a href="https://twitter.com/login?lang=en" title="true">twitter</a></li>
                <li><i className="fa fa-instagram" /><a href="https://www.instagram.com/?hl=en" title="true">instagram</a></li>
                <li><i className="fa fa-google-plus-square" /> <a href="https://plus.google.com/discover" title="true">Google+</a></li>
                <li><i className="fa fa-pinterest-square" /> <a href="https://www.pinterest.com/" title="true">Pintrest</a></li>
              </ul>
            </div>
          </div>
          <div className="col-lg-2 col-md-4">
            <div className="widget">
              ...
              <ul className="list-style">
                <li><a href="about.html" title="true">about us</a></li>
                <li><a href="contact.html" title="true">contact us</a></li>
                <li><a href="terms.html" title="true">terms &amp; Conditions</a></li>
                <li><a href="#" title="true">RSS syndication</a></li>
                <li><a href="sitemap.html" title="true">Sitemap</a></li>
              </ul>
            </div>
          </div>
          <div className="col-lg-2 col-md-4">
            <div className="widget">
              ...
              <ul className="list-style">
                <li><a href="#" title="true">leasing</a></li>
                <li><a href="#" title="true">submit route</a></li>
                <li><a href="#" title="true">how does it work?</a></li>
                <li><a href="#" title="true">agent listings</a></li>
                <li><a href="#" title="true">view All</a></li>
              </ul>
            </div>
          </div>
          <div className="col-lg-2 col-md-4">
            <div className="widget">
              ...
              <ul className="colla-apps">
                <li><a href="https://play.google.com/store?hl=en" title="true"><i className="fa fa-android" />android</a></li>
                <li><a href="https://www.apple.com/lae/ios/app-store/" title="true"><i className="ti-apple" />iPhone</a></li>
                <li><a href="https://www.microsoft.com/store/apps" title="true"><i className="fa fa-windows" />Windows</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div className="blog">
      <div className="container">
        ...
        <div className="owl-navigation">
          <span className="owl-nav-prev"><i className="fas fa-long-arrow-alt-left" /></span>
          <span className="owl-nav-next"><i className="fas fa-long-arrow-alt-right" /></span>
        </div>
      </div>
    </div>
  </section>

    ...
    return (
     ...
     <div className="post-image">
       ...
       <div className="post-info flex-row">
         <span><i className="fas fa-user text-gray" />&nbsp;&nbsp;{props.newarticle.author}</span>
         <span><i className="fas fa-calendar-alt text-gray" />&nbsp;&nbsp;{props.newarticle.publishedAt}</span>
       </div>
     </div>
     <div className="post-title">
       <a href="#">{props.newarticle.title}</a>
       <p>{props.newarticle.description}
       </p>

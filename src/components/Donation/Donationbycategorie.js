                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="top-banner">
                      <h1>List of {state[0].category} donations</h1>
                ...
                <div className="row" id="page-contents">
                  <div className="col-lg-9">
                    <div className="blog-sec left-pading">
                      ...
                      {state.map((donationbycategory) => {
                        return (
                          <DonationCard
                            name={donationbycategory}
                          ></DonationCard>
                        );
                      })}
                    </div>
...
export default Donationbycategorie;

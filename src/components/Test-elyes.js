        ...
        <Modal.Body style={{ maxHeight: 70 + "vh", overflowY: "auto" }}>
          ...
          <div className="col-md-10 offset-xs-1 offset-md-1">
            <p>
              ...
              similique vel voluptatum. A, architecto culpa impedit itaque nihil
              nostrum optio provident sit.
            </p>
                              ...
                              <ul className="activitiez">
                                <li>
                                  <div className="activity-meta">
                                    ...
                                    <h6>
                                      by{" "}
                                      <a href="time-line.html">black demon.</a>
                                    </h6>
                                  </div>
                                </li>
                                <li>
                                  ...
                                  <div className="post-meta">
                                    ...
                                    <div className="description">
                                      <p>
                                        ...
                                        the most beatuiful car available in
                                        america and the saudia arabia, you can
                                        book your test drive by our official
                                        website
                                      </p>
                                    </div>
                                  </div>
                                  ...
                                  <div className="post-meta">
                                    <div className="linked-image align-left">
                                      <a title href="#">
                                        <img
                                          alt
                                          src="images/resources/page1.jpg"
                                        />
                                      </a>
                                    </div>
                            ...
                            <div className="widget stick-widget">
                              ...
                              <ul className="short-profile">
                                ...
                                <li>
                                  ...
                                  <p>
                                    Sacred Games, Spartcus Blood, Games of
                                    Theron{" "}
                                  </p>
                                </li>
                                <li>

                ...
                {user.sender === "bot" ? (
                  <div>
                    <div className="msgalignstart">
                      ...
                      <h6 className="botmsg">{user.msg}</h6>
                    </div>
                    <div>
                      {user.msg ===
                        "what is your feedback on the product received  ?" && (
                        <div>
                          <button
                            onClick={getimage}
                            name="Click the Photo"
                            defaultValue="Click an Image"
                  ...
                  <div className="msgalignend">
                    <h6 className="usermsg">{user.msg}</h6>
              ...
              <div className="full-postmeta">
                ...
                <div>
                  ...
                  <div>
                    <span>
                      {" "}
                      <span className="cat-heading">Shippment:</span>
                      <div className="full-postmeta">
                        <TableContainer component={Paper}>
                          <Table
                            sx={{ minWidth: 500 }}
                  ...
                  <div>
                    <span>
                      <span className="cat-heading">order Status:</span>
                      <div>
                        <div className="full-postmeta">
                                ...
                                <tr>
                                  ...
                                  <th scope="col">
                                    ...
                                    <Dialog open={open} onClose={handleClose}>
                                      ...
                                      <DialogContent>
                                        <DialogContentText>
                                          To edit order status, please enter
                                          your order status ("ordered",
